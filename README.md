# PM Accelerator Weather API
- this is a FastAPI application designed to fetch current and historical weather data.
...
- he API documentation (Swagger UI) will be available at http://127.0.0.1:8000/docs.
- weather api link : https://rapidapi.com/maruf111/api/weather-api167/playground/apiendpoint_ea06a1fa-522f-43e0-be1a-0edb3e8c2623
